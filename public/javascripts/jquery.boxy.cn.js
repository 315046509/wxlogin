...
var j_boxy_cn_info = { ok : '确定', cancel : '取消'}; 
    ...
    return this.each(function() {      
        ...
        if (node == 'a') {
            jQuery(this).click(function() {
                ...
                if ($(this).attr('boxy-modal')) localOptions.modal = true;
...
function Boxy(element, options) {
    ...
    this.setContent($("<div></div>").append($(element)));
    this._setupTitleBar();
...
jQuery.extend(Boxy, {
    ...
    alert: function(message, callback, options) {
        return Boxy.ask(message, [j_boxy_cn_info.ok], callback, options);
    },
    
    // displays an alert box with a given message, calling after callback iff
    // user selects OK.
    confirm: function(message, after, options) {
        return Boxy.ask(message, [j_boxy_cn_info.ok, j_boxy_cn_info.ok.cancel], function(response) {
            if (response == j_boxy_cn_info.ok) after();
        }, options);
    },
...
Boxy.prototype = {
    ...
    show: function() {
        ...
        if (this.options.modal) {
            ...
            if (Boxy.IE6) {
                this._fixIESelect(this.modalBlackout);
            }
    ...
    loadContent : function(url,data,callback){
        this.getContent().html('<div class="boxy-content-loading"><img src="/images/boxy/loading.gif" /></div>').load(url,data,callback);
    },
    ...
    _fitWindow : function(){
        ...
        content.css('width','530').css('height','130');
        
        var conSize = this.getContentSize();
        var winsize = this._getWindowSize();
        
        if(winsize.width - conSize[0] < 100){
            content.css('width',winsize.width - 100);
        }
        if(winsize.height - conSize[1] < 100){
            content.css('height',winsize.height - 100);
        }
        return this;
    },
    ...
    _fixIESelect : function(pobj){
        var iframe = document.createElement('iframe');
        iframe.setAttribute('frameborder', '0');
        iframe.className = 'overSelect';
        $(iframe).css('width',pobj.width()).css('height',pobj.height());
        pobj.append(iframe);
        return this;
    }
...
//		$("body").append('<a id=\"Float\" style=\"display:block; width:170px; height:380px; position: absolute;top: 50.5px; z-index: 10002; left: 0px;\" href=\"http:\/\/www.wowoj.com\/zhuanti\/2013yuandan\/\"><img style=\"display:block; width:170px; height:380px;\" src=\"\/zhuanti\/2013yuandan\/images\/right_scroll 170X380.gif\" \/><\/a>');
//		$(window).scroll(function (){
//		var offsetTop = $(window).scrollTop() + 50.5 +"px";
