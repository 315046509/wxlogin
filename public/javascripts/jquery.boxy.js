...
jQuery.extend(Boxy, {
    ...
    _handleResize: function(evt) {
        ...
        jQuery('.boxy-modal-blackout').css('display', 'none').css({
            width:  jQuery.fixedDucumentSize().w,//d.width(), 
			height:  jQuery.fixedDucumentSize().h//d.height()
        }).css('display', 'block');
    },
...
Boxy.prototype = {
    ...
    show: function() {
        ...
        if (this.options.modal) {
			...
			jQuery.fixSelectBlock(this.modalBlackout);
